...
function BoardDelete(){
    ...
    const cancel=()=>{
        nav(-1)
        // history.back() => history.go(-1) => useNavigate : history , 화면이동
        // -1 이전화면
    }
    const del2=()=>{
        if(pwd.trim()==="")
                    ...
                    <div className="row">
                        <div className={"col-12"} style={{"fontSize":"20px"}}>
                            <table className={"table"}>
                                ...
                                <tr>
                                    <td className="text-center">
                                        <button className={"myButton mr-1"} onClick={del2} style={{"fontSize":"20px"}}>삭제</button>
                                        <button className={"myButton"} onClick={cancel} style={{"fontSize":"20px"}}>취소</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
